...
- 2a0b266: Every JSON response `HonoServer` emits now goes through the configured conventions, and duplicate-route detection catches routes that differ only in parameter name.
